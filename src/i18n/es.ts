...
export const es = {
  ...
  "status.manualDraftReady": "Borrador manual listo. Pega los detalles de la oferta en la estructura Markdown.",
  "status.editedDraftKept": "Borrador editado conservado.",
  ...
  "confirm.replaceEditedDraft": "¿Quieres reemplazar tu borrador editado con una captura nueva de esta oferta compatible?",
